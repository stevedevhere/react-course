...
3. Создать компонент инпута внешний вид которого будет зависеть от родительского компонента. [`context`] (не обязательно)
...
5. Сделать слайдер с использованием Children API.
