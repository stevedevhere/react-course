...
// Свойство defaultProps обязательно нужно описывать вне класса таким образом.
```
...
// Свойство propTypes обязательно нужно описывать вне класса таким образом. 
``` 
...
Детальнее об особенностях работы этой функции можно прочесть [здесь](https://reactjs.org/docs/state-and-lifecycle.html)
